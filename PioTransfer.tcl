...
#
# PioTransfer.tcl: Tcl script for re-creating project 'PioTransfer'
#
...
# Save old sources
file delete -force PioTransfer.srcs.backup
file rename PioTransfer.srcs PioTransfer.srcs.backup
...
set script_file "PioTransfer.tcl"
...
# Create project
create_project PioTransfer . -part xc7z010clg400-1 -force
# Restore old sources
file delete -force PioTransfer.srcs
file rename PioTransfer.srcs.backup PioTransfer.srcs
...
set obj [get_projects PioTransfer]
...
set_property "sim.central_dir" "D:/Development/FPGA/PioTransfer/PioTransfer.ip_user_files" $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/PioTransfer.srcs/sources_1/IpCustom/PIO_registers_1.0"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/PioTransfer.srcs/sources_1/bd/ProcessingSystem/ProcessingSystem.bd"]"\
 "[file normalize "$origin_dir/PioTransfer.srcs/sources_1/hdl/PioTransfer.vhd"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "PioTransfer" $obj
...
set file "[file normalize "$origin_dir/PioTransfer.srcs/constrs_1/PioTransfer.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "constrs_1/PioTransfer.xdc"
...
puts "INFO: Project created:PioTransfer"
